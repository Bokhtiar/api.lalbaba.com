...
@section('admin_content')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">Banner Bundle Show</li>
                <li class="breadcrumb-item active">Banner Bundle Details</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <div class="card">
        <div class="card-header">
            <span class="font-weight-bold">Banner Bundle Name :</span> {{ $show->title }}
        </div>
        <div class="card-body">
            <div class="row my-3">
                ...
                <div class="col-sm-12 col-md-7 col-lg-7">
                    ...
                    <span>
                        ...
                        @php
                        $products = json_decode($show->products);
                        @endphp
